...
/* package trading-0.1.0.0 */
#define VERSION_trading "0.1.0.0"
#define MIN_VERSION_trading(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "trading-0.1.0.0-EBIye5jE6zaAqvnIq0fj6h"

#define CURRENT_PACKAGE_KEY "trading-0.1.0.0-EBIye5jE6zaAqvnIq0fj6h"
